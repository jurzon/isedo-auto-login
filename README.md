...
Po spustení sa automaticky otvorí prehliadač Google Chrome, prebehne prihlásenie a systém vás presmeruje priamo do sekcie "Tvorba objednávky", kde nastaví kurzor, aby ste mohli okamžite použiť čítačku čiarových kódov.
